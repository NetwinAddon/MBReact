...
class ChangePassword extends Component {
    ...
    sendData(
      ...
      async (obj, response) => {
        ...
        if (res === 'FALSE') {
          ...
          this.props.setLoginPass(this.state.NewPassword);
  ...
  ValidateForm() {
    ...
    // if (this.props.LoginPass === this.state.OldPassword) {
    // } else {
    //   this.setState({ Old_error: 'Current password missmatched' });
    //   result = false;
    // }
    ...
    if (this.state.NewPassword.length > 0 && this.state.ConfirmNewPassword.length > 0) {
      if (
        !MyValidator.isConfirmPassword(this.state.NewPassword, this.state.ConfirmNewPassword).isValid
      ) {
        this.setState({
          Confirm_error: MyValidator.isConfirmPassword(
          ...
          <View style={styles.HeaderStyle}>
            ...
            >
              <View style={styles.CurveView}>
                <Text style={styles.Text_Heading}>Change Login Password</Text>
                    ...
                    {this.state.stus_Password && (
                      <View>
                        ...
                        <View style={styles.OldPassBg}>
                          ...
                          {this.state.Old_error !== '' && (
                            <Text style={styles.ErrorDisplay}>{this.state.Old_error}</Text>
                          )}
                        </View>
                        ...
                        <View style={styles.NewPassBg}>
                          ...
                          {this.state.New_error !== '' && (<Text style={styles.ErrorDisplay}>{this.state.New_error}</Text>)}
                        </View>
