...
class MyAccountMiniStatement extends Component {

    constructor(props) {
        super(props);

        console.log("props are MiniAccount======", props.route.params)
    ...
    tominiStatementPage() {
        navigation.navigate(this, 'myAccMiniStatement')
    }
                        ...
                        {this.state.showView &&
                            ...
                            <View style={{ flex: 1, marginTop: 20 }}>
                                <ScrollView
                                    ...
                                    {/* onPress={() => navigation.navigate(this, 'myAccMiniStatement', this.DepositAccList[i])} */}
                                        ...
                                        {this.SavingAccList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccMiniStatement', this.SavingAccList[i])}
                                        ...
                                        {this.LoanAccList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccMiniStatement', this.LoanAccList[i])}
                                        ...
                                        {this.CurrentAccList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccMiniStatement', this.CurrentAccList[i])}
                                        ...
                                        {this.SmallSavingAccList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccMiniStatement', this.SmallSavingAccList[i])}
                                        ...
                                        {this.ShareAccountList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccMiniStatement', this.ShareAccountList[i])}
...
export default connect(mapStateToProps, mapDispatchToProps)(MyAccountMiniStatement);