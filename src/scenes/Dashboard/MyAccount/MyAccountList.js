...
class MyAccountList extends Component {
    ...
    constructor(props) {
        super(props);
        console.log("props are MyAccount======", props.route.params)
    ...
    toAccountDetails() {
        navigation.navigate(this, 'myAccDetails')
    }

    groupByActype() {
        // var total = 0.0;
        const groupedByAccount = this.accDetails.reduce((acc, item) => {
            console.log("$$$$$$$", item.ACTYPE, acc)
            const existingActype = acc.find(obj => obj.Name == item.ACTYPE);
            console.log("$$$$$$$", existingActype)
            if (existingActype) {
                existingActype.items.push(item);

            } else {
                acc.push({
                    Name: item.ACTYPE,
                    isExpanded: false,
                    itemId: item.ACMASTCODE,
                    items: [item]
                });
            }
            return acc;
                                        ...
                                        {this.SavingAccList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccDetails', this.SavingAccList[i])}
                                        ...
                                        {this.LoanAccList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccDetails', this.LoanAccList[i])}
                                        ...
                                        {this.DepositAccList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccDetails', this.DepositAccList[i])}
                                        ...
                                        {this.CurrentAccList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccDetails', this.CurrentAccList[i])}
                                        ...
                                        {this.SmallSavingAccList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccDetails', this.SmallSavingAccList[i])}
                                        ...
                                        {this.ShareAccountList.map((object, i) => {
                                            return (
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => navigation.navigate(this, 'myAccDetails', this.ShareAccountList[i])}
...
export default connect(mapStateToProps, mapDispatchToProps)(MyAccountList);
