...
class DataCardPaymentSuccess extends Component {
    constructor(props) {
        super(props);
        this.state = {};
            ...
            <View style={styles.MainView}>
                ...
                <View style={styles.SubView}>
                    ...
                    <View style={styles.ImageView}>
                        ...
                        <Text style={[styles.SubText, { color: this.props.textColor, }]}> Data Card Payment Successfully Done.</Text>
                    </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(DataCardPaymentSuccess);
