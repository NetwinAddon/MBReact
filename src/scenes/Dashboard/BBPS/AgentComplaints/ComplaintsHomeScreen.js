...
class ComplaintsHomeScreen extends Component {
    ...
    constructor(props) {
        ...
        this.accData = [
            { label: 'Agent not willing to print receipt', value: '1' },
            { label: 'Agent misbehaved ', value: '2' },
            { label: 'Agent outlet closed.', value: '3' },
            { label: 'Agent denying registration of complaint', value: '4' },
            { label: 'Agent not accepting certain bills', value: '5' },
            { label: 'Agent overcharging', value: '6' },
        ];
     
        this.PaymentsStatus = {
            PaymentMode: "Agent",
            TransactionId: "Maharashtra State Electricity Board Limited",
                ...
                >
                    ...
                    <View style={styles.headingContainer}>
                        <View style={styles.innerContainer}>
                            <Text style={styles.title}>Agent Complaints</Text>
                            <Text style={styles.subtitle}>Log Agent Service Complaint</Text>
                        </View>
                    </View>
                                ...
                                <View style={styles.otpContainer}>
                                    ...
                                    >
                                        ...
                                        <TouchableOpacity
                                            ...
                                            onPress={() => this.props.navigation.navigate("agentComplainSuccess")}
                                            // this.onSubmitClick()
                                        > 
                                        <Text
                                        style={[
