...
class FundTransferSameBankSuccess extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidMount() {
        ...
        } else if (this.state.callFrom === 'Edit Beneficiary') {
            setTimeout(() => {
                navigation.navigate(this, 'sameBankOtherAcc');
            }, 1500);
            ...
            <View style={styles.container}>
                ...
                <View style={styles.contentContainer}>
                    <View style={styles.innerContainer}>
                        ...
                        ) : this.state.callFrom === 'Edit Beneficiary' ? (
                            <Text style={[styles.text, { color: this.props.textColor, }]}>
                                Beneficiary Successfully Modified.
                            </Text>
                    ...
                    <View style={styles.buttonContainer}>
                        <CardView cardElevation={3} cardMaxElevation={3} cornerRadius={12} style={styles.cardView}>
                            <TouchableOpacity
...
export default connect(mapStateToProps, mapDispatchToProps)(FundTransferSameBankSuccess);
