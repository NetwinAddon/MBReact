...
class NeftAddBeneficiary extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    onSelectAccount = (value, title, acmastcode) => {
    ...
    ValidateForm() {
        var result = true;
        this.setState({ error_mobileNo: '', error_confirmBeneficiaryAccNo: '', error_confirmBeneficiaryAddress: '', error_confirmBeneficiaryName: '', error_beneficiaryAccountNo: '' });
        ...
        if (this.state.confirmBeneficiaryName.trim() === '') {
            this.setState({ error_confirmBeneficiaryName: 'Please enter beneficiary name' });
            result = false;
        }
        ...
        // if (Number(this.state.beneficiaryAccountNo) != Number(this.state.confirmBeneficiaryAccNo)) {
        //     Snackbar.show({ text: 'Confirm beneficiary account number does not match', duration: Snackbar.LENGTH_SHORT, backgroundColor: 'red' });
        //     result = false;
        // }
        return result;
    };
                    ...
                    async (obj, response) => {
                        ...
                        if (finalRes.SUCCESS === "TRUE") {
                            ...
                            if (SuccessMsg === 'Duplicate Beneficiary...') {
                                ...
                                navigation.navigate(this, 'NeftTransferSuccess', { from: 'Add Beneficiary' })
                    ...
                    <KeyboardAvoidingView
                        ...
                        <View style={styles.headerView}>
                            <View style={styles.headerLabelView}>
                                ...
                                <Text style={styles.addBeneficiaryTextDesciption}>Add Beneficiary for NEFT Fund Transfer
                                </Text>
                            </View>
                        </View>
                        <View style={styles.mainViewContainer}>
                            ...
                            <ScrollView
                                ...
                                <TouchableOpacity style={styles.benficiaryAccNoTouchable}
                                    ...
                                    <TextInput style={styles.confirmBeneficiaryTextInput}
                                        theme={{
                                            colors: {
                                                placeholder: '#DFE1E8',
                                                text: this.props.textColor,
                                        ...
                                        onChangeText={beneficiaryAccountNo => {
                                            console.log("beneficiaryAccountNo: ", beneficiaryAccountNo)
                                ...
                                <TouchableOpacity style={styles.benficiaryAccNoTouchable}
                                    ...
                                    <TextInput
                                        ...
                                        onChangeText={confirmBeneficiaryAccNo => {
                                            console.log("confirmBeneficiaryAccNo: ", confirmBeneficiaryAccNo)
...
export default connect(mapStateToProps, mapDispatchToProps)(NeftAddBeneficiary);
