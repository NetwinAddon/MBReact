...
class NeftTransferOtp extends Component {
    constructor(props) {
        super(props);
        this.state = {
            otp: '',
                    ...
                    async (obj, response) => {
                        if (response.SUCCESS === "FALSE") {
                            ...
                            if (this.state.errorCount === 3) {
                                ...
                                navigation.navigate(this, 'neftMenu', { from: this.state.callFrom, accList: this.state.accList })
                            ...
                            navigation.navigate(this, 'NeftTransferSuccess', { from: this.state.callFrom, refNo: referenceNumber })
                        }
                ...
                <ImageBackground style={styles.mainView}
                    ...
                    <KeyboardAvoidingView
                        ...
                        <View style={styles.enterOtpView}>
                            <Text style={[styles.enetrOtpText, { color: this.props.textColor }]}>{strings.enterOTP}
                            </Text>
                            ...
                            {this.state.OTPcount < 2 ? (
                                <View sstyle={styles.resendOtpView}>
                                    {this.state.timer === "00" ?
                                        <TouchableOpacity
                                            onPress={() => { 
                                                if (Platform.OS === 'ios') {
                            ...
                            <View style={styles.transactionPinView}>
                                <TextInput style={styles.transPinTextInput}
                                    theme={{
                                        colors: {
                                            placeholder: '#DFE1E8',
                            ...
                            {/* <CardView
                                ...
                                ><Text style={[styles.submitButtonText, { color: this.state.otp_length.length >= 3 && this.state.transPin.length >= 3 ? colors.white : colors.btnDisableTextColor }]}>
                                        {strings.submit}
                                    </Text>
                                </TouchableOpacity>
                            </CardView> */}
...
export default connect(mapStateToProps, mapDispatchToProps)(NeftTransferOtp);