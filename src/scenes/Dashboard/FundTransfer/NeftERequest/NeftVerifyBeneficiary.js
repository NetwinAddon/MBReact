...
class NeftVerifyBeneficiary extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    toggleModal = () => {
        this.setState({ isBeneficiaryPopupVisible: false, searchTerm: '', filteredData: this.state.myJsonArrayforBeneficiaryList })
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(NeftVerifyBeneficiary);