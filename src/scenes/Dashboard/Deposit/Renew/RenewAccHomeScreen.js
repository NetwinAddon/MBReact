...
class RenewAccHomeScreen extends Component {
 constructor(props) {
  super(props);
  this.accData = [
 ...
 renderPlansItem = ({item}) => (
  ...
  >
   <TouchableOpacity onPress={() => this.props.navigation.navigate('renewAccScreen')}>
...
export default connect(mapStateToProps, mapDispatchToProps)(RenewAccHomeScreen);
