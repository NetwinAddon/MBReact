...
class UPI_PTwoM extends Component {
    ...
    GetQRCode = async (item) => {
        ...
        console.log("P2M call--" + JSON.stringify(jsonReq))
        ...
        console.log("P2M Body--" + JSON.stringify(Body))
        ...
        sendData(this,
            ...
            async (obj, response) => {
                ...
                // console.log("P2M finalRes--" + JSON.stringify(finalRes))
            ...
            <View style={styles.flexOne}>
                ...
                <ImageBackground style={styles.flexOne}
                    ...
                    <View style={styles.HeaderBg}>
                        ...
                        <Text style={styles.HeaderText}>P2M QR Code</Text>

                        <Text style={styles.HeaderSubText}>Select Account for P2M QR Code</Text>
...
export default connect(mapStateToProps, mapDispatchToProps)(UPI_PTwoM);
